package sv.edu.ufg.fis.amb.contentprovider_gabrielcampos
...
class MainActivity : AppCompatActivity() {
    ...
    private  fun createImagenUri():Uri{
        ...
        return FileProvider.getUriForFile(this,"sv.edu.ufg.fis.amb.contentprovider_gabrielcampos.FileProvider", imagen)
    }
